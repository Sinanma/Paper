...
library(dplyr)
library(tibble)
>>>>>>> 5a359313b23fb50d7b2728e88c1634bb95678190
```
...
Some of our data is of penguins (@fig-room_occupancy), from @palmerpenguins.

```{r}
<<<<<<< HEAD
#| label: fig-room_occupancy
#| fig-cap: Monthly Average Occupancy of Shelter Rooms in Toronto, 2022
=======
#| label: tbl-torontoo
...
```{r}
#| label: fig-by_sector
#| fig-cap: Comparative Analysis of Shelter Room Occupancy by Sector and Program Model Across Toronto Cities
#| echo: false
#| warning: false
#| message: false
toronto_shelters_clean |>
...
And also planes (@fig-by_sector). (You can change the height and width, but don't worry about doing that until you have finished every other aspect of the paper - Quarto will try to make it look nice and the defaults usually work well once you have enough text.)
...
#| tbl-cap: "Explanatory models of Toronto's shelters usage based on occupancy rate rooms and service user count"
#| warning: false
